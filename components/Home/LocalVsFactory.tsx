      ...
      <div className="grid md:grid-cols-12 gap-6 items-start text-left">
        <div className="col-span-2 grid gap-2 p-6">
          <div className="flex items-center h-20">
            <p className="font-bold text-xl text-[#05172D] ">PRICE</p>
          </div>
          <div className="flex items-center h-20">
            <p className="font-bold text-xl text-[#05172D] ">LEAD TIME</p>
          </div>
          <div className="flex items-center h-20">
            <p className="font-bold text-xl text-[#05172D] ">QUANTITIES</p>
          </div>
          <div className="flex items-center h-20">
            <p className="font-bold text-lg whitespace-nowrap text-[#05172D] ">
              PRODUCT RANGE &<br />
              CUSTOMISATION
            </p>
          </div>
